...
const SolutionItem = ({ icon, title, description, className = "" }: SolutionsProps & {className?: string}) => {
  return (
    <div className={`bg-linear-to-r from-primary-green to-secondary-blue p-[2px] rounded-3xl w-[340px] h-[300px] ${className}`}>
